...
╚══════╝ ╚═════╝ ╚═╝     ╚═╝ ╚═════╝ ╚═╝  
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Muhammad SUMON
\033[1;37m Facebook:            MD Sumon Islam
\033[1;37m Github  :            SumonIslam1
...
def cutter():
    ...
    print(" ")
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +sumon)
    os.system('sort -r '+ssb+' | uniq > '+sumon)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + ssb )
    print("New File Saved:" + sumon )
    print(47*'-')
    input(f"{S} Press Enter To Back SSB Menu ")
    SSB(allkey)       
